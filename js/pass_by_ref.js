...
// Make obj1 point to this <object>
var obj1 = {
  name: 'tom',
  age: 57
};

// Make obj2 also point to this <object>
// NOTE: WE ARE ONLY GIVING obj2 a ptr to <object>!!!
var obj2 = obj1;

// should be the same cuz both obj1 and obj2
// are pointing to <object>
console.log("obj1.name is " + obj1.name);  // "tom"
console.log("obj2.name is " + obj2.name);  // "tom"

/*
 Memory:
 memory location for obj1 contains a pointer to <object>
 memory location for obj2 contains a pointer to <object>
...
// Accessing obj1.name will:
// 1. Find obj1 in memory.
// 2. Get it's pointer
// 3. Get the object pointed to.
// 4. Get the property value for name

// Change obj1.name property to "jill"
obj1.name = "jill";

// should be the same cuz both obj1 and obj2
// are pointing to <object>
console.log("obj1.name is " + obj1.name);  // "jill"
console.log("obj2.name is " + obj2.name);  // "jill"
